...
import { ClientMessage, HostMessage, PlayerView } from '@/games/hottake/engine/types';
import { clearSession, saveSession } from '@/games/hottake/net/persistence';
 ...
 * later. If a rejoin is rejected (seat no longer exists), it falls back to
 * a fresh join once.
 */
